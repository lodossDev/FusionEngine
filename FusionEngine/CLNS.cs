    ...
    public class CLNS {
        ...
        public class BoundingBox {
            ...
            private void SetSpriteColor(BoxType type) {
                ...
                sprite = new Texture2D(GameManager.GraphicsDevice, 1, 1);
            ...
            public virtual void DrawRectangle(DrawType drawType) {
                ...
                if (drawType == DrawType.FILL) {
                    GameManager.SpriteBatch.Draw(sprite, new Vector2((float)rect.X, (float)rect.Y), rect, color * VISIBILITY * visibility, 0.0f, new Vector2(0, 0), 1.0f, SpriteEffects.None, 0.0f);
                }
            }
            ...
            public static void DrawStraightLine(Vector2 A, Vector2 B, Texture2D tex, Color color, int thickness) {
                ...
                GameManager.SpriteBatch.Draw(tex, rect, color);
            }
        }
        ...
        public class AttackBox : BoundingBox {
            ...
            public AttackBox(int w, int h, int x, int y, float zDepth = 30, float hitPauseTime = 0, 
                                        float painTime = 40, int hitDamage = 1, int hitPoints = 5, float hitStrength = 0.4f, 
            ...
            public void SetAttack(float zDepth = 30, float hitPauseTime = 0, 
                                        float painTime = 40, int hitDamage = 5,
