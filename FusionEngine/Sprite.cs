...
namespace FusionEngine {
    ...
    public class Sprite {
        ...
        public Sprite(String content, List<String> frames, Animation.Type animationType = Animation.Type.REPEAT, int resetFrame = 1) : this(animationType) {
            var spriteSheetLoader = new SpriteSheetLoader(GameManager.ContentManager);
        ...
        public Sprite Clone(int index) {
            ...
            Texture2D target = new Texture2D(GameManager.GraphicsDevice, source.Width, source.Height);
