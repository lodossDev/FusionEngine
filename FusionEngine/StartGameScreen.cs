...
namespace FusionEngine {
    public class StartGameScreen : GameScreen {
        ...
        public StartGameScreen(ScreenManager manager) {
        ...
        protected override void DrawMain(GameTime gameTime) {
        ...
        protected override void DrawFront(GameTime gameTime)
        {
            //bar.Render();
            //bar2.Render();
